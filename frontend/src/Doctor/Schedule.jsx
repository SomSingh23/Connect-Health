...
function Schedule() {
  ...
  const HandleClick = useCallback(() => {
    if (rid === undefined) {
      ...
      navigate(`/doctor/schedule/autogenerated-${random}`);
  ...
  return (
    <>
      <Helmet>
        <title>Connect Health | Doctor | Start Consultation</title>
      </Helmet>
      ...
      <div className="room_id_form">
        <div className="Opt">
          <input
            ...
            placeholder="Provide a random 5-digit number, e.g., 18282"
            required
          />
          <button onClick={HandleClick} className="buttonDsb2">
            Start Consultation
          </button>
        </div>
      </div>
